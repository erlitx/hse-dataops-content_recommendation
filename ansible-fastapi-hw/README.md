...
**После создания виртуалки, собрал контейнер:**

ansible-playbook -i inventory.ini playbook.yml

**И проверил его работоспособность:**
ansible -i inventory.ini all -m ping

**Для проверки работы модели подключился к адресу виртуалки (он динамический, поэтому указывать его бессмысленно)**
